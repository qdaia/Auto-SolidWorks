...
**Current version: prerelease.** [Release notes](release-0.5.5-rc4.en.md) · [v0.5.4 stable](https://github.com/qdaia/Auto-SolidWorks/releases/tag/v0.5.4). Adds drawing coverage review, native projection/section capture and bounded family verification. Independent drawing acceptance remains incomplete.

[简体中文](download.zh-CN.md) | **English** · [Back to README](../README.en.md)

## Auto SolidWorks 0.5.5-rc4
...
[Download Windows plugin ZIP](https://github.com/qdaia/Auto-SolidWorks/releases/download/v0.5.5-rc4/auto-solidworks-0.5.5-rc4-windows-x64.zip) · [SHA-256 checksum](https://github.com/qdaia/Auto-SolidWorks/releases/download/v0.5.5-rc4/auto-solidworks-0.5.5-rc4-windows-x64.zip.sha256) · [GitHub Release](https://github.com/qdaia/Auto-SolidWorks/releases/tag/v0.5.5-rc4)

For agent-assisted installation, send this message to your agent: Help me install https://github.com/qdaia/Auto-SolidWorks

For manual installation, download `auto-solidworks-0.5.5-rc4-windows-x64.zip` using the link above, extract it, and run the following command in the extracted directory:
