...
[下载 Windows 插件 ZIP](https://github.com/qdaia/Auto-SolidWorks/releases/download/v0.5.1/auto-solidworks-0.5.1-windows-x64.zip) · [SHA-256 校验文件](https://github.com/qdaia/Auto-SolidWorks/releases/download/v0.5.1/auto-solidworks-0.5.1-windows-x64.zip.sha256) · [GitHub Release](https://github.com/qdaia/Auto-SolidWorks/releases/tag/v0.5.1)

发送此消息至agent一键安装：帮我安装https://github.com/qdaia/Auto-SolidWorks

手动安装：下载上方链接中的 `auto-solidworks-0.5.1-windows-x64.zip` 并解压，在解压目录执行：
